...
public class DbBeanInstance implements DbBeanInstInterface {
    ...
    public SmokDatasourceName getMainDsn() {
        return mainDsn;
    }

    public SmokDatasourceName getCassDsn() {
        return cassDsn;
    }

    public SmokDatasourceName getJdbcDsn() {
        return jdbcDsn;
    }
...
//        String sql = mj.getR
    ...
    public int deleteBeanById(Class<? extends BaseDistillerEntity> beanClass, String table, MultiId id) throws SQLException {
