...
public class DbBeanWithFailOverInstance implements DbBeanWithFailOverInterface {
    ...
    private SmokDatasourceName name;

    private SmokDataSource source;
    ...
    private SmokDatasourceName sourceName;

    public DbBeanWithFailOverInstance(DBEnvSetup dbEnvSetup, SmokDataSource source, SmokDatasourceName name){
        sourceName = null;
        this.source = source;
            ...
            namedTemplate  = factory.getNamedParamJdbcTemplate(name).orElse(null);
