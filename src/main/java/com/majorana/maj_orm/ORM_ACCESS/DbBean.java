...
public class DbBean implements DbBeanInterface{
  ...
  protected static HashMap<Class, DbBeanGenericInstance> typeBeans = new HashMap<>();
    ...
    public <T extends BaseMajoranaEntity> DbBeanGenericInterface<T> getTypedBean(Class<? extends BaseMajoranaEntity> T) throws ClassNotFoundException, SQLException
     {
  ...
  protected DbBeanGenericInstance getTypedBeanFromStore(Class s){
    ...
    protected  void putTypedBeanToStore(Class s, DbBeanGenericInstance<? extends BaseMajoranaEntity> b){
        typeBeans.put(s,b);
    }
...
//    public Object[] getBeansArrayWithSelectClause(Class<? extends BaseMajoranaEntity> beanClass, String sql, Object[] params) throws SQLException {
...
//    }
    ...
    public Object getBeanNPWithSelectClause( Class<? extends BaseMajoranaEntity> beanClass, String sql, String[] paramNames, Object[] params) throws SQLException {
